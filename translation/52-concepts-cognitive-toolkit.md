...
> 概念改变我们的思维方式。在知道进化之前，我们无法解释大多周遭发生的事；比如，为什么地球上的物种如此多样？我们整理了一些概念的列表，这些概念改变了我们的思维方式，可能有效地补充你的心智工具包。
...
> 并非所有列出的概念都是有用的。实际上，你会发觉有些完全没用。每个人的思维方式可能处于不同阶段，也许在你所处的阶段#7显得太直白或不适用，而#26正好是能帮助你回答一直在苦苦思考问题的概念。我们编写这份列表，因为我们确认自己曾经非常需要这样的列表。我们也希望你能受益。我们将继续追寻类似的概念，如果你有什么想法，请留言。
...
> 大部分概念还有很多未尽之言。不过，我们试图保持简洁，尽量简化，同时提供大量链接，以供感兴趣的读者参考。阅读这些链接将对本文附加非常高的价值，因为如果你只是简单读一下定义，许多概念看上去显而易见，几乎不值一提。只有看到实例及概念如何改变你的思考，才能更好理解概念的价值。
...
> 1. 信号/反信号 - 这个概念指的是行为向某人传达了该行动者的信息。购买昂贵的婚戒传达的信息是你不会认为自己会在婚礼后立刻逃跑（免得你损失三个月的工资）。反信号则是当你想发出的信号非常明显，完全不需要发出该信号。比如，沃伦巴菲特不需要坐着法拉利兜风来显示自己多富裕，这是尽人皆知的事实。而不坐着法拉利兜风也不会将他跟不需要开法拉利的大众分开。注：巴菲特还住在奥马哈的房子里，在1958年这房子就值31,000美元，而现在价值已经逾十亿，但这可能并非出于反信号的原因。
...
> 2. 微调 - 将选项展示给目标受众的方式，会对他们的行动施加强大的效果，甚至不需要改变通常的激励措施来激发个人积极性。你可以安装杜绝新闻订阅的插件，来减少之后刷Facebook的时间。税务机关可以写信说，90%跟你同工种的人都完成了税务申报。你的电力公司可以安装电表，不停地提醒你在给定时间内使用了多少瓦数。男性便池有时在正中设置了一幅小而简陋的苍蝇图片，作为减少，嗯，飞溅的靶心。 
 ...
 >3. 边际思维 - 额外资源有多少价值？如果你没有香蕉，然后得到一个香蕉，对你的价值可能多于你已经有一百万香蕉再给你一个。这概念很重要，因为可能会让你理解不是所有香蕉对你的价值都是均等的。再举个不常见的小例子，对你的慈善捐款更重要的是这笔捐款的用途，而不是慈善机构募集资金的平均数。额外捐款可能对蚊帐的分发有用，如果已经建成了分发渠道，就可以派送更多出去。相反，也可能已经达到最大配给额度，而额外捐款买了价值10元而不是5元的蚊帐。幸运的是，对抗疟疾基金会还在以超高效发送蚊帐，也是你假日捐款的好对象。
...
> 4. 系统1和系统2思维 - 我们做决策时使用两种不同的系统。系统1是快速、潜意识的，通常被形容为“直觉”。在社交场合或时间紧迫时占优势。系统2是慢速的、更有条理，更适用模型和数字，也是有意识的。
...
> 系统1和系统2
 ...
 > 5. 相对与绝对优势 - 如果你工作赚得比我多，也更擅长打扫房子，你在两项活动中占据绝对优势。这是否意味着，如果两者都让你做，对我俩会更好？不一定。假如你工作每小时赚100美元，是我的时薪10美元的10倍。另外，你打扫房间的速度又是我的两倍。在这两份工作中，我在打扫房间上“最不坏”，所以取决于这种安排带来的社会成本，如果你付我每小时25美元来打扫你的房间，可能对我俩会更好。人们一般做自己干起来“最不坏”的行动，从而发挥相对优势。
...
> 6. [(有效市场假说](https://en.wikipedia.org/wiki/Efficient-market_hypothesis) - 有许多人跟你一样聪明，价值取向也差不多跟你一样。这种事不大可能，你走在大街上就能踩到地上躺着的一百万美元，而没人捡起来。同样，不大可能你能在股票市场上能找到能盈利达到一般公司100倍的公司，而没人发现并投资（驱动公司的部分价格，也就是股份，增长）。基于同样的原因，你可能很难找到一个停车场同时是(1)免费的(2)就在工作地点边上(3)能停一整天。就算存在这样的停车场，久而久之消息传出去，要不很快就会被塞满，要么总有一天会收费。[一切都是市场](http://marketsineverything.com/)。所以，采用有效市场假说，你应该1) 在其他人系统性思考无法触及的地方，寻找你看重的东西，2) 有些事情看上去太好，不像真的，那多半就不是真的。
...
> 7. 透明度假象 - 我们往往高估了自己的心理状态为他人所知的程度，英语的模糊性无法改善这一事实。“伊莉萨白 牛顿创建了一个简单的测试，认为可以说明这一现象。她会用手指敲出一首知名的歌曲，比如“生日快乐”或国歌，让测试对象猜歌名。人们通常估计能有一半被试者猜对，但实际只有3%选对了正确的歌曲。敲歌的人能在他或她的脑海中听到每个音符和歌词，但观测者无法知道敲歌人的想法，只能听出敲击的节奏。” - 来自Wiki。这一现象也适用于对新概念的解释和情感状态的说明。 
...
>8. 机会成本 - 当我们做一项选择，也就意味着放弃了另一项。如果你只吃得下一顿饭，而你喜欢泰式炒河粉，你会选择它。但这意味着你没法同时享用马沙文咖喱，你第二喜欢的食物。经济学家称此为你的机会成本-你的选择减去从第二最佳选项带来的好处。机会成本无处不在，是决策的重要成分。如果你没有捐款给最好的慈善机构，你就没有最大化地帮助别人。此外，如果你没有花费时间在最重要的事上，也会产生机会成本。
...
> 9. 认知偏差 - 这是我们思考过程中的系统性错误。我们不会去找证明自己错误的信息。我们估计自己更容易记得的事情会更多发生，也许只是因为这些事最近发生，或经常被媒体报道。我们很自信，尤其是与专业技能相关的事，或更多一箩筐。令情况更复杂的是这种想法，只有我们的朋友和同事才有偏见。
 ...
 > 10. 启发思维 - 用经验法则在不确定的情况下做决定，我们做的几乎所有独立决策都是这样。这既是祝福，也是诅咒。当没有可供明确处理的信息时，这方法更快、更有效。但本质上，这使我们推演出不一定真实的规则。意识到我们在使用启发思维是有意义的，因为这可能会导致错误。
 ...
 > 11. 反事实推理 - 反过来会发生什么？你可以推开医护人员，自己做心肺复苏，但你可能做得很糟。如果不是反效果，就算你拯救了病人，你这个反事实所起的作用可能也很小。如果医生去发展中国家，那里的病人可能没有受过或没资格接受高质量的医疗，这些想有大作为的医生会做得更好。
...
> 12. 贝叶斯推理 - 在事件前设置初始概率，接收证据信息，再更新之前设置的概率。这是有益的，只要它驱使你思考概率性。而且，这使得我们思考竞争的证据，促使我们细致观察，从而避免对“好与坏”结果非黑即白地简单应用。 
...
> 13. 预期值 - 每个结果的概率乘以相应的价值。比如，二分之一的机会赢得100美元意味着价值50美元，你会愿意投入最多50美元去争取胜算，但不会更多。实例：如果你有两种互斥的方法来助人，你会以10%的几率帮助十亿人，还是以90%的几率帮助一百万人（等量于十亿，其他都一样）？不使用预期值，这个问题几乎无法解答。
...
> 14. 金钱的时间价值 - 我们更愿意今天就获得100美元，而不是明天或明年。实际上，这暗示今天的金钱比以后的更值钱。这一偏好来自于我们有可能以5%的利率投资这笔钱，一年就能增加5美元。现在获取的钱比明年能获取的少多少，是我们愿意的底线呢？这取决于贴现率，在这个例子里是5%。
...
> 15. 囚徒困境/公地悲剧 - 博弈论中的一个问题，可用于解释大量实际问题。该情况下，两个游戏者选择是合作还是竞争。如果两人都选择合作，对大家都有好处。但如果你不合作，而对方试图合作，情况对你更有利。如果两人都不合作，那么对大家都没好处。但如果你是试图合作的笨蛋，而对方不愿合作，那你的情况不能更糟了。这种例子包括：不限制碳排放的国家获取经济利益，但最终损害所有人的利益；使用兴奋剂的运动员更有竞争力，但如果每个人都这样做对大家都没好处；社会上人们缴税用来修建道路，但每个人宁愿坐享道路而自己不用赋税；等等…
...
> 16. 显示偏好 - 空话无益，相比一厢情愿的认识，行动更能揭示我们的喜好。比如，尽管我会说我最喜欢在吐司上放酸酯酵母，但实际上我买了咸味酱 (参考#justaustralianthings)。如此，我的行动表明什么才是真爱。再举一个例子，当特斯拉公司可能调查了数以千计澳大利亚人，其中60%说他们会花更多钱买环保汽车，但汽车真上市时，只有10%的人真的买了。
...
> 17. 典型心理陷阱 - 错误地认为其他人也和我们有相同心理体验。如链接内容所示，我们之间差得太远了。详实的问卷表明，要求在脑海中“看见”一匹斑马时，有些人只是简单回顾斑马的概念，而另一些人则能数斑马的条纹！
...
> 18. 你的时间价值 - 你可以用时间赚更多钱，或做其他你认为值得做的事。如果开车到小镇另一头去买杂货能节省10美元，而要多花一个小时，暗示你的自由时间值10美元1小时。如果你看了“单亲母亲一小时赚1000美元 - 谷歌恨她”的故事后，自己开了个创业公司，每小时只能赚6美元，绕路买东西可能是个不错的选择。但如果你朋友格蕾丝能把她的剩余时间转换成工作，每小时挣50美元，那么对她多开一个小时的车就太浪费了。而且，如果格蕾丝和你一起志愿参加流动厨房，你会很高兴在那儿每小时挣10美元，而格蕾丝会考虑工作，把赚的钱捐出来，她工作的一个小时内可以雇佣5个像你这样的人施粥。
...
> 19. 基本归因错误 - 将别人的错误归结于个性问题，但将自己的错误归结于环境因素。看到有人踢自动售货机，你会觉得他们容易愤怒。而当自己踢自动售货机时，这是因为你又热又渴，你的老板是混蛋，而自动售货机私吞了你仅剩的几块钱。
...
> 20. 奥曼一致理论 - 如果两个理性的人基于一模一样的信息得出不同的看法，有一个人肯定搞错了。“一样信息”是个关键条件，通常不一致的看法来自不一致的信息源，而不是推理的错误。所以，如果你有理由相信对方有你所不知的关键信息，你应该重视对方的看法。
...
> 21. 打口水仗 - 用简单又无关紧要的问题取代困难而重要的问题。在设计核电站时，帕金森注意到委员会浪费了大量时间来打口水仗，比如要用什么材料，位于什么地方等等。每个人都能回答这些问题，也希望别人能听到自己的回答。不幸的是，有些关键细节的讨论时间可能因此缩减，像怎样防止电站泄露杀死大家。
...
> 22. 模因 - 基因的社会性等价物，不编码蛋白，而代表习俗、行为和思想。他们也能自我复制（可以在人群中传播）、突变，有些在特定人群中被选中，也就是能传播。跟自私的基因一样，最有用的模因不一定是传播最广的。反而是那些有外部特征最容易被选择。模因很有趣，能帮助你预测。例如，如果没有“找到（或创造）类似思想的人来参加活动”这个模因，就几乎不会在社会上存在大规模社交活动。
...
> 23. 阿尔杰农定律 - 如果没有利益交换，健康人群的智商很难提高。如果我们能通过简单机制变得更聪明，比如提升乙酰胆碱水平，而没有任何副作用（在原始环境下），那么进化机制可能早就会升高乙酰胆碱水平了。可以将此等同于提升大脑性能的“有效市场假设”。
...
> 24. 社会直觉 - 直觉通常是主导道德判断的基础，之后再被合理化。比如，奴隶制本来是社会常规，被大众接受。当被问（“奴隶制好吗？”）时，赞成奴隶制的人会反思这个回答（“是”），再虚构理由（“因为他们不是人”或类似的恶劣谎言）。这个例子说明，盲信直觉可能有害或事与愿违，因为直觉可能被败坏的社会规范腐蚀。奴隶制的支持者不仅回答错误：他们的思考过程也是错误的，而我们现在还是如此。
...
> 27. 道德牌 - 当你觉得自己做了点好事后，你会做些不大好的事。早上捐款给慈善机构，下午就不大会替别人拉门。
...
> 28. 切斯特顿的栅栏 - 如果看不出栅栏的价值，也不要拆掉，以免你被树后愤怒的公牛撞倒。如果看不出社会规范设置的目的，比如家庭单位是否有存在价值，在苦苦思索前，你不应该对此视而不见。询问支持家庭单位的人们，为什么会认为它很重要，注意到他们推理的漏洞，仅仅这样做还不够好。
...
> 29. 佩兹曼效应 - 当感觉更安全的时候，你更想冒险。安全带刚开始引入时，摩托车手实际上开得更快，更接近前方的汽车。
...
> 30. 塞梅尔魏斯反射 - 不依照优点评估证据，反而因为它与现有规范、信仰、范式抵触就拒绝它。与现状偏见类似，现状偏见是有人可能会选择与互换实验对抗。
...
> 31. 贝特曼原理 - 性选择权最强的性别会花费最多精力在养育后代上。人类中，女性会花费更多精力养育后代，表现在产妇死亡率、哺乳、养育上，也是有更多选择权的性别。海马里面则相反：雄海马把后代装入育儿袋，选择配偶时也有更多选择权。

32. Hawthorne effect - people react differently when they know they are being observed.

> 32. 霍桑效应 - 如果知道自己正在被观测，人们会表现得与平时不同。
...
> 33. 布佛氏论证 - 基于对手如何推理直接驳回其论点，而不是合理的反驳。比如，“你就是有偏见！”或者“你害怕替代选择，当然会这样认为。”
...
> 34. 弗林效应 - 自从20世纪30年代以来，每十年IQ会增长3点。为什么会发生这一现象、这一趋势是否会持续下去，还在激烈争论中。
...
> 35. 谢林点 - 人们会自然而相互独立地汇聚成一个论点。比如，如果你和我某天要在悉尼见面，而我们不知道时间和地点，我们可能去通常聚会的地方，或者转而在中午12点悉尼歌剧院碰头。在必须协调而难以明确讨论时，这种效应非常重要。何况参加者可能还不知道它的发生。比如，“我不想住在这样的社区，对孩子们的基因强化扩大了贫富差异。不幸的是，我们没法明确在什么场合下才能说‘等等，我们要踏入这个社会，不要再强化了！’也许同事和我应该反对任何形式的基因操作，包括选择没有囊性纤维化的胚胎，就算我们不介意特定的选择发生。”
...
> 36. 局部最优对全局最优 - 请看下面这幅精心绘制的图片。总之，你可能需要把事情弄糟来达到全局最优点，也就是所有情况下最好的点。如果想赚更多，你得牺牲近期投入在工作上的时间，以参加会增加你未来收入的课程。
...
> 局部最优对全局最优。结果通常会停留在局部最优，这是在探索与开发之间取得权衡。
...
> 37. 人择原理 - 给你一片安眠药，如果投硬币得到正面会唤醒你两次，而负面会唤醒你一次。你醒来了。有多大几率今天你会醒两次？同样，有多大几率我们在有生命存在的唯一宇宙？

38. Arbitrage - taking advantage of different prices between markets for the same products.

> 38. 套利 - 利用同一产品在不同市场的不同价格来牟利。
...
> 39. 混沌理论 - “混沌：现在决定未来，但大致的现在并不近似地决定将来。”
...
> 双杆钟摆动画显示混沌行为。从稍微偏离的初始条件开始钟摆，会形成完全不同的轨迹。
...
> 40. 群内与群外心理学 - 可以解释现象，如仇外、左右派别的政治鸿沟。我们关注的圈子可能随时间而扩展。
...
> 41. 红皇后假说 - 生物需要持续进化，分别用来对付天敌的攻击和猎物的防御。这一效果可能应该归功于性别的存在。
...
> 45. 向均值回归 - 如果有一次你（在正态分布中）得到了极端结果，更多的结果可能更倾向于接近平均的选择值。如果只有一次试验表明保健品x比其他的好太多，你不应该完全相信这个结论。
...
> 46. 认知失调 - 同时持有两个冲突的信念，会使我们觉得不大舒服，从而拒绝（至少）其中一个。比如，认为科学是发现真相的有效途径，可能与疫苗导致自闭症这一信念相冲突。如果你认为两者皆对，至少有一点需要被否定。
    
47. Coefficient of determination - how well a model fits or explains data (i.e. how much of the variance it explains).
    
> 47. 判定系数 - 一个模型能多好地吻合或解释数据（即能解释多少误差）。
...
> 48. 高德温法则 - 当在线讨论时间变长，涉及到纳粹或希特勒的比较可能性逼近1。此时，已经完全失去有意义会话的希望，讨论应当停止。
...
> 49. 承诺与一致 - 如果人们承诺完成一个想法或目标，而完成这个目标与自我形象一致，会更容易履行承诺。即使在协议后原激励或动机已被消除，他们也会继续履行协议。比如，一旦某人在争论中采取了某一观点，很难改变“立场”。
...
> 50. 情感预测 - 很难预测未来你会多幸福，这取决于一些事件或变动。我们通常猜测影响的幅度会比实际更大，因为1）这一事件刚被要求考虑，使它显得比实际在我们日常生活中更重要，2）会低估自己的适应能力。
...
> 51. 费米计算（又名“信封底计算”） - 用少量猜测或已知的数字，得到对感兴趣值的有根据的猜测。为了说明这点，你可以通过采样少量估计值，如人口、有钢琴的房子数、钢琴调音师的效率，来近似算出芝加哥钢琴调音师的数字。
